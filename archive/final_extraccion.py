...
# Step 2: Login con Session (Web Flow + Interactive)
print("\nStep 2: Autenticar...")
print("""
   1. Abre: https://www.instagram.com/accounts/login/
   2. Ingresa tus credentials
   3. Pestaña F12 -> Network -> Headers -> Cookies
   4. Copia el valor de "sessionid" (ej: "AbCdEf...")
""")

sessionid = "ABcdEf123456789..."  # <- CAMBIAR POR EL TUYO

# Configurar Session
try:
    client = Client()
    client.sessionid = "COPIA_TU_SESSIONID_AQUI"
